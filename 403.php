  ...
  <div class="error-page-container">
    ...
    <div class="error-detail-card card-base border border-black/5 dark:border-white/5">
      ...
      <div class="error-graphic-col">
        <div class="error-graphic-code">403</div>
        <div class="error-graphic-label">Forbidden</div>
      </div>
      ...
      <div class="error-info-col">
        <div class="error-info-group">
          ...
          <h2 class="error-info-value">Access Denied</h2>
        </div>

        <div class="error-info-group">
          <span class="error-info-label">Description</span>
          <p class="error-info-value-desc">You do not have permission to access this resource.</p>
        </div>

        <div class="error-info-group">
          <span class="error-info-label">Details</span>
          <pre class="error-json-block"><code>{
  "message": "Forbidden: <?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>",
  "statusCode": 403,
