  ...
  <div class="error-page-container">
    ...
    <div class="error-detail-card card-base border border-black/5 dark:border-white/5">
      ...
      <div class="error-graphic-col">
        <div class="error-graphic-code">404</div>
        <div class="error-graphic-label">Not Found</div>
      </div>
      ...
      <div class="error-info-col">
        <div class="error-info-group">
          ...
          <h2 class="error-info-value">Page Not Found</h2>
        </div>

        <div class="error-info-group">
          <span class="error-info-label">Description</span>
          <p class="error-info-value-desc">Are you sure you entered a right URL?</p>
        </div>

        <div class="error-info-group">
          <span class="error-info-label">Details</span>
          <pre class="error-json-block"><code>{
  "message": "Page not found: <?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>",
  "statusCode": 404,
  "statusMessage": "Page not found: <?php echo htmlspecialchars(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH)); ?>",
  "data": {
